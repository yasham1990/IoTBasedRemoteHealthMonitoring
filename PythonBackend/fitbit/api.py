...
class Fitbit(object):
    ...
    def intraday_time_series(self, resource, base_date='2016-11-20', detail_level='1min', start_time=None, end_time=None):
        """
    ...
    def _get_body(self, type_, base_date='today', user_id=None, period=None,
                  end_date=None):
        if not base_date:
